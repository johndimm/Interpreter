...
function onResult(event) {
  ...
  // When the user pauses for a second, process the entire phrase.  
  g_speechTimer = setTimeout(processCompletePhrase, 1000);
}
...
function startAudioButton(turnOn) {
  if (!g_recognition) {
    upgrade();
	return;
  }
